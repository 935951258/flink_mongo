...
public abstract class IT21Streamer implements ingestionExecutor {
	...
	public void initialize(Properties props) {
		//load
		this.zooKeeperUrl = props.getProperty(LoadConfig.zooKeeperUrl);
		this.kafkaBrokerUrl = props.getProperty(LoadConfig.kafkaBrokerUrl);
		this.stateDir = props.getProperty(LoadConfig.stateDir);
	}
